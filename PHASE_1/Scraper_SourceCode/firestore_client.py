...
class FireStore_Client:
    ...
    def write_disease_auto_id(self, name: str, symptoms: List[str]) -> str:
        ...
        Returns disease_id.
        """
        disease_id = hashlib.md5((name + ''.join(symptoms)).encode("utf-8")).hexdigest()
    ...
    def write_article_auto_id(self, url: str, headline: str, main_text: str, date_of_publication: datetime) -> str:
        ...
        if date_of_publication is None:
            print(f"NOT sending as no date of publication was given.")
            return
...
if __name__ == "__main__":
    ...
    firestore_client.write_disease_auto_id("cholera", ["profuse watery diarrhea", "vomiting"])
