...
class FireStore_Client:
    ...
    def write_disease_auto_id(self, name: str, symptoms: str):
        """
    ...
    def write_article_auto_id(self, url: str, headline: str, main_text: str, date_of_publication: str):
        """
        Same as 'write_disease' except you don't have the disease_id.
        """
    ...
    def write_report_auto_id(self, article_id: str, disease_id: str, location: str, event_date: str, reported_cases: int = None, hospitalisations: int = None, deaths: int = None):
        """
